...
\item Selezione con Radar Radius: 
\begin{equation}
L = max \sum_{i \in V} c_{v,0} \ 
\end{equation}

\begin{equation}
L = max \sum_{(i,j) \in L} c_{i,j}  
\end{equation}
...
\begin{table}
		\begin{tabular}{c|c|c}
			\includegraphics[scale = 0.15]{images/RR1.png} & \includegraphics[scale = 0.15]{images/RR2.png} & \includegraphics[scale = 0.15]{images/RR3.png}\\
			\\ \hline \\
